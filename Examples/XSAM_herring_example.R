...
source(paste(path,"Examples/ReadHerringData.R",sep=""))
...
#------------------------------------#
setuppath<-paste(path,"XSAMsetup/",sep="")
...
sdpath<-paste(path,"Data/sds/",sep="")
#load SEs for
tmp<-load(paste(sdpath,"sd_C1_12_88_16",sep=""))
tmp1<-load(paste(sdpath,"sd_Cemp1_12_88_16",sep=""))
...
##
source(paste(path,"Rcode/ProjectionProgs.R",sep=""))
source(paste(path,"Rcode/SimProgs2.R",sep=""))
...
savefile<-paste(path,"Results/XSAMfitlist",sep="")
...
source(paste(path,"Rcode/myplot.R",sep=""))
...
PlotXSAMfitobj2(years=XSAMdataobj$years,fitobj=XSAMfit,what="R",p=0.95,add=F,col=1,ylab="",xlab="",lty2=3,axes=F)
axis(1,at=1988:2017)
axis(2)
box()
...
PlotXSAMfitobj2(years=XSAMdataobj$years,fitobj=XSAMfit,what="FbarW",p=0.95,add=F,ylim=c(0,.4),col=1,ylab="",xlab="",lty2=3,axes=F)
axis(1,at=1988:2017)
axis(2)
box()
...
PlotXSAMfitobj2(years=XSAMdataobj$years,fitobj=XSAMfit,what="ssb",p=0.95,add=F,ylim=c(0,10000),col=1,ylab="",xlab="",lty2=3,axes=F)
axis(1,at=1988:2017)
axis(2)
box()
mtext(side=2,"Million tonnes",line=2)
...
#Write reports
source(paste(path,"Rcode/WriteReports.R",sep=""))
